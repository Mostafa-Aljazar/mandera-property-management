...
- `docs/new/openapi.yaml` المرسل من فريق الموبايل لا يحتوي أي مسار للإشعارات أو device tokens إطلاقاً — يحتاج تأكيد من الفريق إذا كانت هذه الميزة مطلوبة بالتطبيق أصلاً قبل بناء نسخة مسطّحة منها.
